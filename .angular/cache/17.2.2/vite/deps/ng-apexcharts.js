  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    var _ = function() {
      ...
      return r(t2, [{ key: "niceScale", value: function(t3, e2) {
        var i2 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0, a2 = 1e-11, s2 = this.w, r2 = s2.globals, o2 = s2.config.xaxis, n2 = s2.config.yaxis[i2], l2 = void 0 !== n2.min && null !== n2.min, h2 = void 0 !== n2.max && null !== n2.min, c2 = void 0 !== n2.stepSize && null !== n2.stepSize, d2 = void 0 !== n2.tickAmount && null !== n2.tickAmount, g2 = ((r2.isBarHorizontal ? r2.svgWidth : r2.svgHeight) - 100) / 15, u2 = d2 ? n2.tickAmount : 10;
        if (r2.isMultipleYAxis && !d2 && r2.multiAxisTickAmount > 0 && (u2 = r2.multiAxisTickAmount, d2 = true), u2 = "dataPoints" === u2 ? r2.dataPoints - 1 : Math.abs(Math.round(u2)), (t3 === Number.MIN_VALUE && 0 === e2 || !x.isNumber(t3) && !x.isNumber(e2) || t3 === Number.MIN_VALUE && e2 === -Number.MAX_VALUE) && (t3 = 0, e2 = u2, r2.allSeriesCollapsed = false), t3 > e2) {
        ...
        var f2 = [];
        u2 < 1 && (u2 = 1);
        var b2 = u2, v2 = Math.abs(e2 - t3);
        if (n2.forceNiceScale) {
          !l2 && t3 > 0 && t3 / v2 < 0.15 && (t3 = 0, l2 = true), !h2 && e2 < 0 && -e2 / v2 < 0.15 && (e2 = 0, h2 = true), v2 = Math.abs(e2 - t3);
        }
        var m2 = v2 / b2, y2 = m2, w2 = Math.floor(Math.log10(y2)), k2 = Math.pow(10, w2), A2 = Math.ceil(y2 / k2);
        if (m2 = y2 = (A2 = r2.niceScaleAllowedMagMsd[0 === r2.yValueDecimal ? 0 : 1][A2]) * k2, r2.isBarHorizontal && o2.stepSize && "datetime" !== o2.type ? (m2 = o2.stepSize, c2 = true) : c2 && (m2 = n2.stepSize), c2 && n2.forceNiceScale && Math.round(Math.log10(m2)) != w2) {
          for (var S2 = v2 / u2; m2 < S2; )
            m2 *= 10;
          for (; m2 > S2; )
            m2 /= 10;
        }
        if (l2 && h2) {
          ...
          if (d2)
            if (c2)
              if (0 != x.mod(v2, m2)) {
                var L2 = x.getGCD(m2, C2);
                m2 = C2 / L2 < 10 ? L2 : C2;
              } else
                0 == x.mod(m2, C2) ? m2 = C2 : (C2 = m2, d2 = false);
            else
              m2 = C2;
          else if (c2)
            0 == x.mod(v2, m2) ? C2 = m2 : m2 = C2;
          else if (C2 = v2 / (b2 = Math.round(v2 / y2)), 0 != x.mod(v2, m2)) {
            var P2 = x.getGCD(v2, y2);
            y2 / P2 < 10 && (C2 = P2), m2 = C2;
          } else
            C2 = m2;
          b2 = Math.round(v2 / m2);
        } else {
          if (l2 || h2)
            h2 ? t3 = d2 ? e2 - m2 * b2 : m2 * Math.floor(t3 / m2) : l2 && (e2 = d2 ? t3 + m2 * b2 : m2 * Math.ceil(e2 / m2));
          else if (d2) {
            var I2 = m2 / (e2 - t3 > e2 ? 1 : 2);
            e2 = (t3 = I2 * Math.floor(t3 / I2)) + m2 * b2;
          } else
            t3 = m2 * Math.floor(t3 / m2), e2 = m2 * Math.ceil(e2 / m2);
          v2 = Math.abs(e2 - t3), m2 = x.getGCD(v2, m2), b2 = Math.round(v2 / m2);
        }
        if (d2 || l2 || h2 || (b2 = Math.ceil((v2 - a2) / (m2 + a2))) > 16 && x.getPrimeFactors(b2).length < 2 && b2++, r2.isMultipleYAxis && 0 == r2.multiAxisTickAmount && (r2.multiAxisTickAmount = b2), b2 > g2 && (!d2 && !c2 || n2.forceNiceScale)) {
          var M2 = x.getPrimeFactors(b2), T2 = M2.length - 1, z2 = b2;
          t:
            for (var X2 = 0; X2 < T2; X2++)
              for (var E2 = 0; E2 <= T2 - X2; E2++) {
                for (var Y2 = Math.min(E2 + X2, T2), F2 = z2, R2 = 1, H2 = E2; H2 <= Y2; H2++)
                  R2 *= M2[H2];
                if ((F2 /= R2) < g2) {
                  z2 = F2;
                  break t;
          ...
          m2 = z2 === b2 && n2.forceNiceScale ? v2 : v2 / z2;
        }
        var D2 = t3 - m2, O2 = m2 * a2;
        do {
          D2 += m2, f2.push(x.stripNumber(D2, 7));
        } while (e2 - D2 > O2);
    ...
    var U = function() {
      ...
      return r(t2, [{ key: "init", value: function() {
        ...
        if (r2.seriesX.length >= a2) {
          var d2;
          if (l2 = 0, h2 = (c2 = u(new Set((d2 = []).concat.apply(d2, u(r2.seriesX.slice(t3, a2)))))).length - 1, s2.xaxis.min)
        ...
        var g2 = r2.series, p2 = g2, f2 = g2;
        "candlestick" === s2.chart.type ? (p2 = r2.seriesCandleL, f2 = r2.seriesCandleH) : "boxPlot" === s2.chart.type ? (p2 = r2.seriesCandleO, f2 = r2.seriesCandleC) : r2.isRangeData && (p2 = r2.seriesRangeStart, f2 = r2.seriesRangeEnd);
        for (var b2 = t3; b2 < a2; b2++) {
          r2.dataPoints = Math.max(r2.dataPoints, g2[b2].length), r2.categoryLabels.length && (r2.dataPoints = r2.categoryLabels.filter(function(t4) {
            return void 0 !== t4;
          }).length), r2.labels.length && "datetime" !== s2.xaxis.type && 0 !== r2.series.reduce(function(t4, e3) {
            return t4 + e3.length;
          }, 0) && (r2.dataPoints = Math.max(r2.dataPoints, r2.labels.length)), c2 || (l2 = 0, h2 = r2.series[b2].length);
          for (var v2 = l2; v2 <= h2; v2++) {
            var m2 = g2[b2][v2];
            if (null !== m2 && x.isNumber(m2)) {
              switch (void 0 !== f2[b2][v2] && (o2 = Math.max(o2, f2[b2][v2]), e2 = Math.min(e2, f2[b2][v2])), void 0 !== p2[b2][v2] && (e2 = Math.min(e2, p2[b2][v2]), i2 = Math.max(i2, p2[b2][v2])), s2.series[b2].type) {
                case "candlestick":
                  void 0 !== r2.seriesCandleC[b2][v2] && (o2 = Math.max(o2, r2.seriesCandleH[b2][v2]), e2 = Math.min(e2, r2.seriesCandleL[b2][v2]));
                case "boxPlot":
                  void 0 !== r2.seriesCandleC[b2][v2] && (o2 = Math.max(o2, r2.seriesCandleC[b2][v2]), e2 = Math.min(e2, r2.seriesCandleO[b2][v2]));
              }
              s2.series[b2].type && "candlestick" !== s2.series[b2].type && "boxPlot" !== s2.series[b2].type && "rangeArea" !== s2.series[b2].type && "rangeBar" !== s2.series[b2].type && (o2 = Math.max(o2, r2.series[b2][v2]), e2 = Math.min(e2, r2.series[b2][v2])), i2 = o2, r2.seriesGoals[b2] && r2.seriesGoals[b2][v2] && Array.isArray(r2.seriesGoals[b2][v2]) && r2.seriesGoals[b2][v2].forEach(function(t4) {
                n2 !== Number.MIN_VALUE && (n2 = Math.min(n2, t4.value), e2 = n2), o2 = Math.max(o2, t4.value), i2 = o2;
              }), x.isFloat(m2) && (m2 = x.noExponents(m2), r2.yValueDecimal = Math.max(r2.yValueDecimal, m2.toString().split(".")[1].length)), n2 > p2[b2][v2] && p2[b2][v2] < 0 && (n2 = p2[b2][v2]);
            } else
        ...
        if (t3.isMultipleYAxis) {
          ...
          for (var a2 = 0; a2 < t3.series.length; a2++) {
            var s2 = this.getMinYMaxY(a2);
            t3.minYArr[a2] = s2.lowestY, t3.maxYArr[a2] = s2.highestY, i2 = Math.min(i2, s2.lowestY);
          }
        }
        var r2 = this.getMinYMaxY(0, i2, null, t3.series.length);
        if (t3.minY = r2.lowestY, t3.maxY = r2.highestY, i2 = r2.lowestY, e2.chart.stacked && this._setStackedMinMax(), "line" === e2.chart.type || "area" === e2.chart.type || "scatter" === e2.chart.type || "candlestick" === e2.chart.type || "boxPlot" === e2.chart.type || "rangeBar" === e2.chart.type && !t3.isBarHorizontal ? t3.minY === Number.MIN_VALUE && i2 !== -Number.MAX_VALUE && i2 !== t3.maxY && (t3.minY = i2) : t3.minY = r2.minY, e2.yaxis.forEach(function(e3, i3) {
      ...
      return r(i2, [{ key: "draw", value: function(t3) {
        ...
        for (var f2 = p2 ? t3.series.length - 1 : 0; p2 ? f2 >= 0 : f2 < t3.series.length; p2 ? f2-- : f2++) {
          ...
          if (s2.setSelectionFilter(I2, 0, f2), this.addListeners(I2, this.radialDataLabels), b2.add(I2), I2.attr({ index: 0, j: f2 }), this.barLabels.enabled) {
            ...
            var Y2 = T2.x - this.barLabels.margin, F2 = T2.y, H2 = i3.drawText({ x: Y2, y: F2, text: z2, textAnchor: "end", dominantBaseline: "middle", fontFamily: this.barLabels.fontFamily, fontWeight: this.barLabels.fontWeight, fontSize: this.barLabels.fontSize, foreColor: E2, cssClass: X2.join(" ") });
    ...
    var Ft = function() {
      ...
      return r(t2, [{ key: "draw", value: function(t3, i2, a2, s2) {
        ...
        for (var d2 = [], g2 = 0; g2 < t3.length; g2++) {
          ...
          if ("rangeArea" === l2) {
            var I2 = this._calculatePathsFrom({ series: s2, i: g2, realIndex: u2, prevX: A2, prevY: C2 }), M2 = this._iterateOverDataPoints(e(e({}, L2), {}, { series: s2, pY: k2, pathsFrom: I2, iterations: s2[g2].length - 1, isRangeStart: false }));
            P2.linePaths[0] = M2.linePath + P2.linePath, P2.pathFromLine = M2.pathFromLine + P2.pathFromLine;
          }
        ...
        var e2, i2 = this, a2 = t3.type, s2 = t3.series, r2 = t3.iterations, o2 = t3.realIndex, n2 = t3.i, l2 = t3.x, h2 = t3.y, c2 = t3.pX, d2 = t3.pY, g2 = t3.pathsFrom, u2 = t3.linePaths, p2 = t3.areaPaths, f2 = t3.seriesIndex, b2 = t3.lineYPosition, v2 = t3.xArrj, y2 = t3.yArrj, w2 = t3.y2Arrj, k2 = t3.isRangeStart, A2 = t3.seriesRangeEnd, S2 = this.w, C2 = new m(this.ctx), L2 = this.yRatio, P2 = g2.prevY, I2 = g2.linePath, M2 = g2.areaPath, T2 = g2.pathFromLine, z2 = g2.pathFromArea, X2 = x.isNumber(S2.globals.minYArr[o2]) ? S2.globals.minYArr[o2] : S2.globals.minY;
        ...
        for (var E2 = function(t4, e3) {
          ...
          var O2 = this.lineHelpers.calculatePoints({ series: s2, x: l2, y: h2, realIndex: o2, i: n2, j: R2, prevY: P2 }), N2 = this._createPaths({ type: a2, series: s2, i: n2, realIndex: o2, j: R2, x: l2, y: h2, y2: Y2, xArrj: v2, yArrj: y2, y2Arrj: w2, pX: c2, pY: d2, linePath: I2, areaPath: M2, linePaths: u2, areaPaths: p2, seriesIndex: f2, isRangeStart: k2 });
          p2 = N2.areaPaths, u2 = N2.linePaths, c2 = N2.pX, d2 = N2.pY, M2 = N2.areaPath, I2 = N2.linePath, !this.appendPathFrom || "monotoneCubic" === S2.config.stroke.curve && "rangeArea" === a2 || (T2 += C2.line(l2, this.zeroY), z2 += C2.line(l2, this.zeroY)), this.handleNullDataPoints(s2, O2, n2, R2, o2), this._handleMarkersAndLabels({ type: a2, pointsPos: O2, i: n2, j: R2, realIndex: o2, isRangeStart: k2 });
        }
        return { yArrj: y2, xArrj: v2, pathFromArea: z2, areaPaths: p2, pathFromLine: T2, linePaths: u2, linePath: I2, areaPath: M2 };
        ...
        if (Array.isArray(w2.config.stroke.curve) && (A2 = Array.isArray(v2) ? w2.config.stroke.curve[v2[a2]] : w2.config.stroke.curve[a2]), "rangeArea" === e2 && (w2.globals.hasNullValues || w2.config.forecastDataPoints.count > 0) && "monotoneCubic" === A2 && (A2 = "straight"), "monotoneCubic" === A2) {
          ...
          if (C2 && L2.length > 1) {
            ...
            if (p2 += Xt(P2), null === i2[a2][0] ? f2 = p2 : f2 += Xt(P2), "rangeArea" === e2 && y2) {
              ...
              var I2 = l2.slice().reverse(), M2 = d2.slice().reverse(), T2 = I2.map(function(t4, e3) {
                return [I2[e3], M2[e3]];
              }), z2 = Et(T2);
              f2 = p2 += Xt(z2);
            } else
