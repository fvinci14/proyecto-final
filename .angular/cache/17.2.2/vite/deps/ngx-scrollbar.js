...
function NgScrollbar_ng_container_5_scrollbar_x_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelement(0, "scrollbar-x", null, 4);
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext(2);
    ɵɵattribute("scrollable", ctx_r1.state.isHorizontallyScrollable)("fit", ctx_r1.state.verticalUsed);
  }
}
function NgScrollbar_ng_container_5_scrollbar_y_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelement(0, "scrollbar-y", null, 5);
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext(2);
    ɵɵattribute("scrollable", ctx_r2.state.isVerticallyScrollable)("fit", ctx_r2.state.horizontalUsed);
  }
}
function NgScrollbar_ng_container_5_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, NgScrollbar_ng_container_5_scrollbar_x_1_Template, 2, 2, "scrollbar-x", 3)(2, NgScrollbar_ng_container_5_scrollbar_y_2_Template, 2, 2, "scrollbar-y", 3);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
...
_NgScrollbar.ɵcmp = ɵɵdefineComponent({
  ...
  template: function NgScrollbar_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵprojection(4);
      ɵɵelementEnd()()();
      ɵɵtemplate(5, NgScrollbar_ng_container_5_Template, 3, 2, "ng-container", 3);
      ɵɵelementEnd();
    }
    if (rf & 2) {
